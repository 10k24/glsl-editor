...
// CodeMirror completion kind for each doc kind. Lives next to DocKind so a
// consumer (the autocomplete source) never re-maps the enum itself.
export const CM_KIND: Record<DocKind, Completion["type"]> = {
  function:  "function",
  type:      "type",
  variable:  "variable",
  qualifier: "keyword",
